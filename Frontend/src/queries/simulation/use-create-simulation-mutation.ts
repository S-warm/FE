...
import { createNotImplementedServiceError, SERVICE_CONFIG, simulationService } from "@/services"
import type { SimulationCreateRequestDto } from "@/types/api/simulation/simulation-create.request"

export function useCreateSimulationMutation(userId = SERVICE_CONFIG.defaultUserId) {
